...
int main() {
  ...
  // error checking
  if (width <= 0) {
    cout <<  "Error: " << "width must be greater than 0. You entered " << 
    width << endl;
    return 0;
  }
  if (height <= 0) {
    cout <<  "Error: " << "height must be greater than 0. You entered " << 
    height << endl;
    return 0;
  }
  if (targetWidth <= 0) {
    cout <<  "Error: " << "target width must be greater than 0. You entered " << 
    targetWidth << endl;
    return 0;
  }
  if (targetHeight <= 0) {
    cout <<  "Error: " << "target height must be greater than 0. You entered " << 
    targetHeight << endl;
    return 0;
  }  
  if (width <= 0) {
